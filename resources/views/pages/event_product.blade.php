...
@section('content')
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">{{ $event_by_id->event_name }}</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="/trang-chu">Trang chủ</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">{{ $event_by_id->event_name }}</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    @foreach ($product_by_event as $key => $product)
                            ...
                            <div class="card product-item border-0 mb-4">
                                ...
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        @elseif($product->event_id != 0 && $product->event_detail->event_detail_status == 1)
                                            <?php
