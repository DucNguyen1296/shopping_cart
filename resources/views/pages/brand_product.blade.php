...
@section('content')
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">{{ $brand_by_id->brand_name }}</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="/trang-chu">Trang chủ</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">{{ $brand_by_id->brand_desc }}</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a
                    href="{{ url('danh-muc-san-pham/' . $brand_by_id->category_id) }}">{{ $brand_by_id->category->category_name }}</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">{{ $brand_by_id->brand_name }}</li>
        </ol>
    </nav>
    <!-- BreadCrumb End -->
                ...
                <div class="border-bottom mb-4 pb-4">
                    ...
                    <form>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            ...
                            <label class="custom-control-label" for="price-all">Theo màu sắc</label>
